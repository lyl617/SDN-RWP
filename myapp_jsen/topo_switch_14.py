#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 23/07/2018 9:38 PM
# @Author  : Jsen617
# @Site    : 
# @File    : topo_switch_14.py.py
# @Software: PyCharm
# coding:utf-8
...
class toposwitch14(simple_switch_14.SimpleSwitch14):
    def __init__(self,*args,**kwargs):
        super(toposwitch14,self).__init__(*args,**kwargs)
    ...
    #- switch class is in ryu.topology.switches.switch,it contains the switch's dpid,port,etc
