#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 18/07/2018 8:17 PM
# @Author  : Jsen617
# @Site    : 
# @File    : simple_switch_14.py.py
# @Software: PyCharm
...
class SimpleSwitch14(app_manager.RyuApp):
    ...
    def __init__(self,*args,**kwargs):
        super(SimpleSwitch14,self).__init__()
        self.datapaths = {}
        self.mac_to_port = {}
        self.flow_id = 0
    ...
    def add_flow(self,datapath,priority,match,actions,buffer_id=None):
        ...
        inst = [parser.OFPInstructionActions(ofproto.OPFIT_APPLY_ACTIONS,actions)]
    ...
    def _packet_in_handler(self,ev):
       # If you hit this you might want to increase
        ...
        if out_port != ofproto.OFPP_FLOOD:
            ...
            #verify if we hava a valid buffer_id,if yes avoid to send both
            #flow_mod & packet_out
            if msg.buff_id != ofproto.OFP_NO_BUFFER:
                data = msg.data
            out = parser.OFPPacketOut(datapath=datapath,buffer_id=msg.buff_id,in_port=in_port,
